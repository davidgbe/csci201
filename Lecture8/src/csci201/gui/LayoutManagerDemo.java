...
public class LayoutManagerDemo extends JFrame {
	...
	public LayoutManagerDemo() {
		...
		JLabel jl = new JLabel("This is a border layout");
		borderLayoutPanel.add(jl, BorderLayout.CENTER);
		...
		gridLayoutPanel.setLayout(new GridLayout(3,3));
		for(int i = 1; i < 10; i++) {
			JButton jb1 = new JButton("" + i);
			gridLayoutPanel.add(jb1);
		}
